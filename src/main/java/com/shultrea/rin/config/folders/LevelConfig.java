...
public class LevelConfig {
	...
	private static final int maximumLevel = 10;
	@Config.Name("Adept")
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int ancientSealedCurses = 1;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int difficultysEndowment = 5;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int disorientatingBlade = 4;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int smelter = 1;
	@Config.Name("Sol's Blessing")
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int solsBlessing = 5;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int trueStrike = 1;
	@Config.Name("Swift Swimming")
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int swiftSwimming = 3;
	@Config.Name("Unreasonable")
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int unreasonable = 2;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int upgradedPotentials = 1;
	@Config.Name("Viper")
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int viper = 5;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int curseOfPossession = 1;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int runeArrowPiercing = 4;
	@Config.Name("Rune: Magical Blessing")
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int runeMagicalBlessing = 4;
	@Config.Name("Rune: Piercing Capabilities")
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int runePiercingCapabilities = 4;
	@Config.Name("Rune: Resurrection")
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int runeResurrection = 2;
	...
	@Config.RequiresMcRestart
	@Config.RangeInt(min = minimumLevel, max = maximumLevel)
	public int advancedEfficiency = 5;
