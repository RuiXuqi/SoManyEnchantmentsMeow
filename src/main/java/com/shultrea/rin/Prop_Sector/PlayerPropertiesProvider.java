...
public class PlayerPropertiesProvider implements ICapabilitySerializable<NBTTagCompound> {
	...
	private final IPlayerProperties propertyInstance = PLAYERPROPERTIES_CAP.getDefaultInstance();
	...
	public <T> T getCapability(Capability<T> capability, EnumFacing facing) {
		return capability == PLAYERPROPERTIES_CAP ? PLAYERPROPERTIES_CAP.cast(this.propertyInstance) : null;
	}
