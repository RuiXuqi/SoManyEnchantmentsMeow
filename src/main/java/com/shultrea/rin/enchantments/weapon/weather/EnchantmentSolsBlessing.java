...
public class EnchantmentSolsBlessing extends EnchantmentBase {
	...
	public boolean canApplyAtEnchantingTable(ItemStack stack){
		return ConfigProvider.canItemApply(this, ModConfig.canApply.solsBlessing, stack) && super.canApplyAtEnchantingTable(stack);
	}

	@Override
	public boolean canApply(ItemStack stack){
		return ConfigProvider.canItemApply(this, ModConfig.canApplyAnvil.solsBlessing, stack) || super.canApply(stack);
	}
	...
	public void onEntityDamagedAlt(EntityLivingBase attacker, Entity target, ItemStack weapon, int level) {
		...
		if(!attacker.world.isRemote && attacker.world.isDaytime() && EnchantUtil.canEntitySeeSky(attacker)) {
			...
			victim.addPotionEffect(new PotionEffect(MobEffects.GLOWING, 20 + 10 * level));
		}
	}
