...
/**
 * Enchantment also has effects in EnchantmentEvasion and EnchantmentParry
 */
public class EnchantmentTrueStrike extends EnchantmentBase {
	...
	public boolean canApplyAtEnchantingTable(ItemStack stack){
		return ConfigProvider.canItemApply(this, ModConfig.canApply.trueStrike, stack) && super.canApplyAtEnchantingTable(stack);
	}

	@Override
	public boolean canApply(ItemStack stack){
		return ConfigProvider.canItemApply(this, ModConfig.canApplyAnvil.trueStrike, stack) || super.canApply(stack);
	}
