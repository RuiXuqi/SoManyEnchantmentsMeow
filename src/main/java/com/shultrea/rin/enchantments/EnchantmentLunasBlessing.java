...
public class EnchantmentLunasBlessing extends EnchantmentBase implements IWeatherEnchantment {
	
	public EnchantmentLunasBlessing(String name, Rarity rarity, EnumEnchantmentType type) {
	...
	public void onHurtEvent(LivingHurtEvent e) {
		...
		if(this.isOffensivePetDisallowed(e.getSource().getImmediateSource(), e.getSource().getTrueSource())) return;
