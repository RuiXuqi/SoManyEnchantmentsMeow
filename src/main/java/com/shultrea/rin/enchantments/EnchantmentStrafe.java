...
public class EnchantmentStrafe extends EnchantmentBase {
	...
	public boolean canApplyTogether(Enchantment fTest) {
		return fTest != Enchantments.INFINITY && fTest != Enchantments.PUNCH && fTest != Smc_030.AdvancedPunch && super.canApplyTogether(fTest);
	}
	...
	public void onEvent(LivingEntityUseItemEvent.Tick event) {
		...
		if(EnchantmentHelper.getEnchantmentLevel(Smc_030.Strafe, bow) > 0) if(bow.getItem() instanceof ItemBow) {
