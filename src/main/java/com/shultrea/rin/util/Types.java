...
public abstract class Types {
	...
	private static final Predicate<Item> PREDICATE_GAPPLE = item -> item instanceof ItemAppleGold;
	...
	public static final EnumEnchantmentType COMBAT_GOLDEN_APPLE = EnumHelper.addEnchantmentType("Golden Apple", PREDICATE_GAPPLE);
	...
	public static void initEnchantmentTabs() {
		...
		combatList.add(COMBAT_GOLDEN_APPLE);
