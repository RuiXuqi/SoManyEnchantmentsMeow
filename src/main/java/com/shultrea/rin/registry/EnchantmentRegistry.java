...
public class EnchantmentRegistry {
	...
	public static EnchantmentBase defusingEdge = register(new EnchantmentDefusingEdge("defusingedge", Enchantment.Rarity.RARE, EnumEnchantmentType.WEAPON, EnumSlots.MAIN));
	...
	public static EnchantmentBase dragging = register(new EnchantmentDragging("dragging", Enchantment.Rarity.VERY_RARE, EnumEnchantmentType.BOW, EnumSlots.HANDS));
