...
public class InsnComparator implements Comparator<AbstractInsnNode>, Serializable {
	...
	/**
	 * Respects {@link #INT_WILDCARD} and {@link #WILDCARD} instruction properties. Always returns true if {@code a} and
	 * {@code b} are label, line number, or frame instructions.
