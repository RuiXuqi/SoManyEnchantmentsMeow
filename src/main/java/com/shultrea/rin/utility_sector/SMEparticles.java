...
public class SMEparticles {
	...
	public static void spawnParticle(String name, double x, double y, double z, double vx, double vy, double vz) {
		...
		/**if(name.equals("soulSteal")) {
		 addEffect(new SpecPartEnchSword(world, x, y, z, vx, vy, vz, soulRGB));
		 } else if(name.equals("zombieSummon")){
		 addEffect(new SpecPartEnchSword(world, x, y, z, vx, vy, vz, zombieRGB));
		 } else if(name.equals("featherAttack")) {
		 addEffect(new SpecPartEnchSword(world, x, y, z, vx, vy, vz, featherRGB));
		 } else if(name.equals("enderAttack")) {
		 addEffect(new SpecPartEnchSword(world, x, y, z, vx, vy, vz, enderRGB));
		 } else if(name.equals("blazeAttack")) {
		 addEffect(new SpecPartEnchSword(world, x, y, z, vx, vy, vz, blazeRGB));
		 } else if(name.equals("iceAttack")) {
		 addEffect(new SpecPartEnchSword(world, x, y, z, vx, vy, vz, iceRGB));
