...
public class SMEASM implements IClassTransformer {
	...
	private void hookAllIntegerReturn(MethodNode m, String owner, String name, String desc, AbstractInsnNode... loads) {
		...
		while(anchor.getNext() != null) {
			if(anchor.getOpcode() == Opcodes.IRETURN) {
				...
				for(AbstractInsnNode node : loads) {insert.add(node);}
	...
	private void hookArthropod(MethodNode m) {
		...
		insert.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/shultrea/rin/Hook/HookArthropod", "hookArthropod", "(Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/entity/Entity;)V", false));
	...
	private AbstractInsnNode getNewArthropodHook() {
		return new MethodInsnNode(Opcodes.INVOKESTATIC, "com/shultrea/rin/Hook/HookArthropod", "handleArthropod", "(Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/entity/Entity;Z)V", false);
	}
}
